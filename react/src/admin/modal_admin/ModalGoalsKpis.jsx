...
const ModalGoalsKpis = () => {
    return (
        <div>
            <CreateKpisGoalsModal />
            <UpdateKpisGoalsModal />
            <DeleteKpisGoalsModal />
        </div>
    )
}

export default ModalGoalsKpis
...
export const CreateKpisGoalsModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Create Data"
...
export const UpdateKpisGoalsModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Update Data"
...
export const DeleteKpisGoalsModal = ({ visible, onClose }) => {
    if (!visible) return null;
