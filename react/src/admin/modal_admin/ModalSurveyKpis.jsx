...
const ModalSurveyKpis = () => {
    return (
        <div>
            <CreateKpisSurveyModal />
            <UpdateKpisSurveyModal />
            <DeleteKpisSurveyModal />
        </div>
    )
}

export default ModalSurveyKpis
...
export const CreateKpisSurveyModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Create Data"
...
export const UpdateKpisSurveyModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Update Data"
...
const FormFields = () => (
    <>
        <FormField label="Kategori" placeholder="Input kategori" />
        <FormField label="Deskripsi" placeholder="Input deskripsi" />
    </>
)

export const DeleteKpisSurveyModal = ({ visible, onClose }) => {
    if (!visible) return null;
