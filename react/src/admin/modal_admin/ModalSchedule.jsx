...
export const CreateScheduleModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Create Data"
...
export const UpdateScheduleModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Update Data"
...
const FormFields = () => (
    <>
        ...
        <FormField label="StartDate" placeholder="Input start date" />
        <FormField label="EndDate" placeholder="Input end date" />
    </>
)


export const DeleteScheduleModal = ({ visible, onClose }) => {
    if (!visible) return null;
