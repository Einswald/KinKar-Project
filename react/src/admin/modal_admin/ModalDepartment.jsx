...
export const CreateDepartmentModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Create Data"
...
export const UpdateDepartmentModal = ({ visible, onClose }) => (
    <ModalTemplate
        visible={visible}
        onClose={onClose}
        title="Update Data"
...
export const DeleteDepartmentModal = ({ visible, onClose }) => {
    if (!visible) return null;
