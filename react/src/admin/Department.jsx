        ...
        <div className='pt-6 px-6 md:pt-8 md:px-8'>
            ...
            <div className='flex flex-col rounded-md bg-[#F0F3FF]'>
                ...
                <div className='flex items-center justify-center'>
                    <table className='mt-2 w-8/12 min-w-max table-auto text-left border-b border-[#DDE6ED]'>
                                ...
                                <tr key={index} >
                                    ...
                                    <td className={`${tdTable} w-2/12`}>
                                        <div className='inline-flex'>
                                            ...
                                            <button className='text-red-500 py-1 mr-6' onClick={() => setShowModalDelete(true)}>
                                                <MdDelete className='w-5 h-5' />
                                            </button>
                                            <button className='text-yellow-500 py-1 ' onClick={() => setShowDetailBiodata(true)}>
